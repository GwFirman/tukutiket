...
<div class="mb-6 space-y-3 sm:space-y-0">
    <div class="flex justify-between items-center">
        ...
        <div class="flex items-center gap-2 lg:gap-3">
            ...
            {{-- LOGIKA UTAMA: Hanya tampilkan tombol jika acara BELUM selesai --}}
            @if (!$isFinished)
                ...
                @endif
            @else
                {{-- Opsi Tambahan: Jika ingin menampilkan text "Selesai" (Boleh dihapus jika ingin kosong total) --}}
                <span
                    class="inline-flex items-center gap-2 px-3 py-2 bg-gray-100 text-gray-500 rounded-lg font-medium text-sm cursor-default">
