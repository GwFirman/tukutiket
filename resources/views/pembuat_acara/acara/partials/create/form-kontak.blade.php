<div class="w-full mt-4 border border-gray-100 rounded-2xl">
    <!-- Section Title -->
    ...
    <div class="border-t border-gray-100 p-5 space-y-4  ">
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="info_narahubung" id="info_narahubung"
                    value="{{ old('info_narahubung', $acara->info_narahubung ?? '') }}"
                    ...
                    placeholder="Masukkan nama narahubung" required minlength="3">
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="email" name="email_narahubung" id="email_narahubung"
                    value="{{ old('email_narahubung', $acara->email_narahubung ?? '') }}"
                    class="w-full pl-11 pr-4 py-2.5 border border-gray-300 rounded-lg bg-white text-gray-800 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm"
                    placeholder="Masukkan email narahubung" required>
            </div>
        </div>
        ...
        <div>
            ...
            <div class="relative">
                ...
                <input type="text" name="no_telp_narahubung" id="no_telp_narahubung"
                    value="{{ old('no_telp_narahubung', $acara->no_telp_narahubung ?? '') }}"
                    class="w-full pl-11 pr-4 py-2.5 border border-gray-300 rounded-lg bg-white text-gray-800 placeholder:text-gray-400 focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition text-sm"
                    placeholder="Masukkan nomor telepon" pattern="^[0-9+\-()\s]{8,}$"
                    title="Masukkan nomor telepon yang valid (min 8 digit)">
            </div>
        </div>
    </div>
</div>
