                            ...
                            <div class="p-4 sm:p-6">
                                ...
                                <div class="flex flex-col sm:flex-row sm:justify-between gap-3 sm:gap-4">
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-2 sm:gap-3">
                                        <button
                                            class="inline-flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors text-sm font-medium">
