<x-app-layout>
        ...
        <div class="grid grid-cols-12 gap-2">
                                    ...
                                    <div class="flex justify-between items-center ml-5">
                                        <div>
                                            <div class="flex items-center">
                                                ...
                                                <h3 class="font-semibold text-lg text-gray-800">{{ $tiket->nama_jenis }}
                                                </h3>
                                            </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg col-span-4 p-6">
                ...
                <a href="{{ route('pembeli.acara.show', $acara->slug ?? 1) }}"
                    class="mt-4 bg-indigo-600 hover:bg-indigo-700 text-white block text-center font-medium py-2 px-4 rounded transition duration-300">
                    Checkout
                </a>
            </div>
        </div>
    ...
    <script>
        // Cart object untuk menyimpan tiket yang dipilih
        const cart = {};
            ...
            return {
                ...
                renderCart() {
                    ...
                    for (const [ticketId, item] of Object.entries(cart)) {
                        ...
                        `;
                        detailPesanan.innerHTML += itemHTML;
                    }
